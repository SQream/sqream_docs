...
* :ref:`Workers<sqream_console_cli_reference>`
...
For more information on the current query plan, see :ref:`SHOW_NODE_INFO<show_node_info>`. For more information on checking active sessions across the cluster, see :ref:`SHOW_SERVER_STATUS<show_server_status>`.
