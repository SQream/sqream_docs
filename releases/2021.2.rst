...
* `CREATE FOREIGN TABLE <https://docs.sqream.com/en/v.2021.2/reference/sql/sql_statements/ddl_commands/create_foreign_table.html>`_ - Creating a new foreign table in an existing database.
