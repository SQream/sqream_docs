...
The 4.4 release notes were released on xx/xx/xxxx and describe the following:
...
:ref:`denodo` may now be used for data visualization and real-time visualization of various sources.
