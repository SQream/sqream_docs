...
For more information, see `Window Functions <https://docs.sqream.com/en/latest/reference/sql/sql_syntax/window_functions.html#window-functions>`_ and scroll to the **Ranking Functions** table.
