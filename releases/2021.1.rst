...
* CHARACTER/CHAR - ``text (with and without length definition)
* NATIONAL CHARACTER/NATIONAL CHAR/NCHAR - ``text (with and without length definition)
* CHARACTER VARYING/CHAR VARYING - ``text (with and without length definition)
* NATIONAL CHARACTER VARYING/NATIONAL CHAR VARYING/NCHAR VARYING - ``text (with and without length definition)
...
For more information, see `String Types <https://docs.sqream.com/en/latest/reference/sql_data_types.html#string-types>`_.
...
For more information, see `Data Types <https://docs.sqream.com/en/latest/reference/sql_data_types.html>`_.
