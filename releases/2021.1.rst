...
For more information, see `Numeric Data Types <https://docs.sqream.com/en/v2021.2.1/reference/sql_data_types.html#numeric-data-types.html>`_.
...
For more information, see `String Types <https://docs.sqream.com/en/v2021.2.1/reference/sql_data_types.html#string-types-text-varchar>`_.
...
For more information, see `Subqueries <https://docs.sqream.com/en/v2021.2.1/reference/sql/sql_syntax/subqueries.html>`_.
...
For more information, see `Simple Scalar SQL UDF’s <https://docs.sqream.com/en/v2021.2.1/reference/sql/sql_functions/user_defined_functions/scalar_sql_udf.html>`_.
...
For more information, see `GET_LICENSE_INFO <https://docs.sqream.com/en/v2021.2.1/reference/sql/sql_statements/utility_commands/get_license_info.html>`_.
...
For more information about AWS, see `Amazon S3 <https://docs.sqream.com/en/v2021.2.1/guides/features/external_data/s3.html>`_.
...
For more information about the ``runtimeGlobalFlags`` flag, see the **Runtime Global Flags** table in `Configuration <https://docs.sqream.com/en/v2021.2.1/guides/operations/configuration.html>`_.
