...
For more information, navigate to Windows Functions and scroll to the `Ranking Functions table <https://docs.sqream.com/en/v2021.1.1/reference/sql/sql_functions/window_functions/index.html>`_.
