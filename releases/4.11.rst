...
-----------------------------
► SQDB's new ``DATETIME2`` data type delivers nanosecond precision and timezone control, for reliable and accurate time-based data..
...
+--------------+---------------------------------------------------------------------------------------------------------------------+
| SQ-19675     | Array decompress performance issue                                                                                  |
+--------------+---------------------------------------------------------------------------------------------------------------------+
