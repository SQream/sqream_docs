...
****************
The **Roles** area has been added to `Studio version 5.3.3 <https://docs.sqream.com/en/v2022.1/sqream_studio_5.4.3/creating_assigning_and_managing_roles_and_permissions.html>`_. From the Roles area users can create and assign roles and manage user permissions.
