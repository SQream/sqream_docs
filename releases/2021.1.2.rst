...
For more information, see `String Types <https://docs.sqream.com/en/v2021.1/reference/sql_data_types.html#string-types>`_.
...
For more information, see `Data Types <https://docs.sqream.com/en/v2021.1/reference/sql_data_types.html>`_.

Roles Area Added to SQream Acceleration Studio 5.4.3
****************
The **Roles** area has been added to `SQream Acceleration Studio 5.4.3 <https://docs.sqream.com/en/v2021.1/sqream_studio_5.4.3/index.html>`_. From the Roles area users can create and assign roles and manage user permissions.
