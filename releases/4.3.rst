...
The 4.3 release notes were released on 31/05/2023 and describe the following:
...
To learn more about how and when you should use the new permissions, visit :ref:`access_control_permissions`.
...
When using SQreamDB legacy configuration file and AWS S3, you may be required to use the following new parameters:

* ``AwsEndpointOverride``
* ``AwsObjectAccessStyle``

To learn more about how and when you should use them, visit :ref:`s3`.
...
Support in an :ref:`old method <previous_configuration_method>` of configuring the SQreamDB instance ends on September 30th, 2023.
