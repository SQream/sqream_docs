...
8. To re-enable catalog and UI access, you may either grant access to all system roles using your ``public`` role:

.. code-block::

	GRANT ALL PERMISSIONS ON CATALOG <catalog_name> TO public;
	
Or individually grant access to roles:
