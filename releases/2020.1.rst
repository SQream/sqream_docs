...
**************************
The 2021.2.1 release notes were released on 15/1/2021.
...
For more information, see :ref:`logging` for more information.

Resolved Issues
-------------
The following table lists the issues that were resolved in Version 2020.1:
...
Known Issues
------
The following table shows the known issues relevant to Version 2020.1:
...
.. list-table::
   ...
   * - SQ Number
     - Description
   * - SQ-2216
     - Multiple count distinct performance issue (2020.1 regression)
   * - SQ-2620
     - Operations on Snappy-compressed ORC files are slower than their Parquet equivalents
   * - SQ-2628
     - Copy from: insufficient memory error when there is unclosed quote in csv and the csv file is very big
   * - SQ-2637
     - Performance degradation - tpch10t query22.sql
...
------
The **Naming Convention Modifications** section is not relevant to Version 2020.1.

End of Support
------
The **End of Support** section is not relevant to Version 2020.1.

Deprecated Features
------
The **Deprecated Components** section is not relevant to Version 2020.1.
