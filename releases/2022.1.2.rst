...
Added `zlib` compression
************
Added support for the `zlib` compression algorithm. For more information, navigate to the **Compression Methods** table on the `Compression <https://docs.sqream.com/en/v2022.1.2/feature_guides/compression.html#compression>`_ page.
