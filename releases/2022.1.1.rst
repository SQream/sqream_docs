...
For more information, see `UPDATE <https://docs.sqream.com/en/v2022.1.1/reference/sql/sql_statements/dml_commands/update.html#update>`_.

file:///C:/Users/Yaniv/sqream_docs/_build/html/reference/sql/sql_statements/dml_commands/update.html?highlight=update
...
file:///C:/Users/Yaniv/sqream_docs/_build/html/operational_guides/access_control_password_policy.html?highlight=password%20policy

Compression
************

SQream now supports the **zlib** compression format.

For more information, see `Compression <https://docs.sqream.com/en/v2022.1.1/feature_guides/compression.html#compression-strategies>`_. 

file:///C:/Users/Yaniv/sqream_docs/_build/html/feature_guides/compression.html#compression-strategies
...
+-------------+----------------------------------------------------------------------------------------+
| SQ-10955    | No metadata filters were applied when filtering by a nullable date using ``dateadd``.  |
+-------------+----------------------------------------------------------------------------------------+
...
https://docs.sqream.com/en/latest/configuration_guides/login_max_retries.html
