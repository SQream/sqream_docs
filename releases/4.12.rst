...
-----------------------------
► :ref:`Chunk indexes<accelerating_filtered_statements>` significantly reduce statement execution time when metadata contains millions of keys by intelligently leveraging previously created chunk indexes for efficient data skipping.
