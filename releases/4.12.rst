...
6. Run the following command:
  ...
  .. note:: Column DDL permission is now deprecated as its functionality is fully included within the table DDL permission. For more info please refer to `Deprecation_`
