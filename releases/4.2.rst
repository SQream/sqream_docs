...
The 4.2 release notes were released on 03/19/2023 and describe the following:
...
Pysqream 3.2.4 - `.tar.gz file <https://github.com/SQream/pysqream/releases>`_ Supports Python 3.9

ODBC 4.4.4 :ref:`Getting the ODBC Driver<odbc>`

JDBC 4.5.8 `.jar file <https://sq-ftp-public.s3.amazonaws.com/sqream-jdbc-4.5.8.jar>`_
