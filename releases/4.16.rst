...
► Add support for casting ``TEXT_TO_ARRAY``. This functionality requires completing prerequisite installation steps, see the instructions here :ref:`In-Process Installation Steps<installations_for_in-process_functions>`. For details on how to use this feature, please see :ref:`casting TEXT_TO_ARRAY<text_to_array>`.
...
| **SQ No.**                  | **Description**                                                                            |
+=============================+============================================================================================+
| SQ-20089                    | Fixed issue with handling non-capturing group for REGEXP_SUBSTR and REGEXP_INSTR functions |
+-----------------------------+--------------------------------------------------------------------------------------------+
