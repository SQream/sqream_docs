...
► Add support for casting ``TEXT_TO_ARRAY``. This functionality requires completing prerequisite installation steps, see the instructions here :ref:`In-Process Installation Steps<installations_for_in-process_functions>`. For faeture usage details please see :ref:`casting TEXT_TO_ARRAY<text_to_array>`.
