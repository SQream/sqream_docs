...
► #TODO sharon's comment, left empty for now in the table below (SQ-20089) - 
Instead of this and all of the REGEXP_SUBSTR and REGEXP_INSTR tickets I suggest adding an item similar to above - Description of the supported functionality of  REGEXP_SUBSTR and REGEXP_INSTR
...
| **SQ No.**                  | **Description**                                                                            |
+=============================+============================================================================================+
| SQ-19986                    | Full nvcomp support - #TODO - get approve from Gil then list as a new feature not ticket   |
+-----------------------------+--------------------------------------------------------------------------------------------+
| SQ-20089                    |  bla bla                                                                                   |
+-----------------------------+--------------------------------------------------------------------------------------------+
