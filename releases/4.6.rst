...
► For any new SQreamDB installation and upgrade, the following cluster flags are included in your default :ref:`legacy configuration file<modifying_your_configuration_using_a_legacy_configuration_file>`:
