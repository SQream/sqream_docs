...
+--------------+---------------------------------------------------------------------------------------------------------------------+
| SQ-19051     | Metadata issues causes some data portions to becamoe inaccessible                                                   |
+--------------+---------------------------------------------------------------------------------------------------------------------+
...
Starting October 2024, support for the Haskell CLI is discontinued, and it will be replaced by a JAVA CLI that is compatible with the Haskell CLI with the added value of ``Table-View`` and cross platform compatability.
