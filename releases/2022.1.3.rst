...
**************************
The 2022.1.3 release notes were released on 9/8/2022 and describe the following:
...
New Features
----------
The 2022.1.3 Release Notes include the following new features:
...
Support sub-queries in the UPDATE condition
************
Update functionality has been enhanced to support sub-queries allowing to update table and / or columns based on other table and / or columns.
...
+-------------+-------------------------------------------------------------------------------------------------------------------------------------------+
| SQ-11378    | Python connector fails to run multi threaded per one connection.                                                                          |
+-------------+-------------------------------------------------------------------------------------------------------------------------------------------+
...
+-------------+-------------------------------------------------------------------------------------------------------------------------------------------+
| SQ-11287    | SQL User Defined Function declaration fails when UDF contains parenthesis.                        					          		      |
+-------------+-------------------------------------------------------------------------------------------------------------------------------------------+
...
Deprecated Features
-------
No features were deprecated for Version 2022.1.3.
...
6. Run the following command:
  ...
  .. note:: Upgrading from a major version to another major version requires you to follow the **Upgrade Storage** step. This is described in Step 7 of the `Upgrading SQream Version <https://docs.sqream.com/en/v2022.1.3/installation_guides/installing_sqream_with_binary.html#upgrading-sqream-version>`_ procedure.
