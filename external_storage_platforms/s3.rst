...
***********************
<<<<<<< Updated upstream
Ingestinging Data Using Amazon S3
=======
Inserting Data Using Google Cloud Platform
>>>>>>> Stashed changes
***********************
SQream uses a native S3 connector for ingesting data. The ``s3://`` URI specifies an external file path on an S3 bucket. File names may contain wildcard characters, and the files can be in CSV or columnar format, such as Parquet and ORC.
