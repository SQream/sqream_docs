...
'TEXT_TO_ARRAY' is In-process function which implemented in Python. All In-process functions uses locally installed Python with additional requirements - Mentioned here: :doc:`installations_for_in-process_functions`
