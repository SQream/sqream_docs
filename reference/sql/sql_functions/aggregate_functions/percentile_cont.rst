...
The **PERCENTILE_CONT** function is commonly used with the `MODE <https://docs.sqream.com/en/v2021.2/reference/sql/sql_functions/aggregate_functions/mode.html>`_ function.
