...
Use :ref:`show_subscribed_instances` to view service subscriptions for each worker. Use `SHOW_SERVER_STATUS <https://docs.sqream.com/en/v2021.1/reference/sql/sql_statements/monitoring_commands/show_server_status.html>`_ to see the statement queues.
...
For more information, in Studio, see `Executing Statements and Running Queries from the Editor <https://docs.sqream.com/en/v2021.1/sqream_studio_5.4.3/executing_statements_and_running_queries_from_the_editor.html>`_.
...
For more information, see the `JDBC Client Driver <https://docs.sqream.com/en/v2021.1/guides/client_drivers/jdbc/index.html>`_.
...
For more information, see the `ODBC Client Driver <https://docs.sqream.com/en/v2021.1/third_party_tools/client_drivers/odbc/index.html>`_.
...
For more information, see the `Python (pysqream) connector <https://docs.sqream.com/en/v2021.1/third_party_tools/client_drivers/python/index.html>`_.
...
For more information, see the `Node.js Client Driver <https://docs.sqream.com/en/v2021.1/third_party_tools/client_drivers/nodejs/index.html>`_.