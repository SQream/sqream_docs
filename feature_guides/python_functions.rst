...
.. note:: Starting v2022.1.4, Python UDF are disabled by default in order to enhance product security. Use the ``enablePythonUdfs`` :ref:`configuration flag<enable_python_udfs>` in order to enable Python UDF.
