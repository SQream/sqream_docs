...
.. table:: nvCOMP Compression Algorithms
   :widths: 15 85
...
+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Deflate** | Combines two techniques: **LZ77** (finds and replaces repeating data strings) and **Huffman coding** (assigns shorter bit codes to frequent symbols). This two-step process makes Deflate an efficient and popular algorithm, widely used in formats like Gzip and ZIP.                                                                                             |
+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Bitcomp** | A **Bit-level compression algorithm for numerical data**. It optimizes storage by using the **minimum number of bits** required for each value, rather than a fixed size (e.g., compressing 32-bit integers that only use 8 bits down to their actual size). (Note: Out of first stage scope)                                                                       |
+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
