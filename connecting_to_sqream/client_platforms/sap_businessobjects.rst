...
1. In the fields, provide a user name, password, database URL, and JDBC class.
   ...
   .. code-block:: console
      ...
      jdbc:Sqream://<IP address>:3108/<database name>
   ...
   For more information, see `Connection String Examples <https://docs.sqream.com/en/v2021.1.1/connecting_to_sqream/client_drivers/jdbc/index.html#connection-string-examples>`_.
