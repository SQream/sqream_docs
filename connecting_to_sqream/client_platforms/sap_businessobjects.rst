...
1. In the fields, provide a user name, password, database URL, and JDBC class.
   ...
   For more information, see `Connection String Examples <https://docs.sqream.com/en/v2020.3.2/connecting_to_sqream/client_drivers/jdbc/index.html#connection-string-examples>`_.
