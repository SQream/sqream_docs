...
6. In the **JDBC URL** field, type the relevant connection string.
   ...
   For connection string examples, see `Connection Strings <https://docs.sqream.com/en/v2020.3.2.1/connecting_to_sqream/client_drivers/jdbc/index.html#connection-string-examples>`_.
