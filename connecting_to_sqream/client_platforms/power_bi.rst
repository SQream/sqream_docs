...
2. Download and configure your ODBC driver.
   ...
   For more information about configuring your ODBC driver, see `ODBC <https://docs.sqream.com/en/latest/third_party_tools/client_drivers/odbc/index.html>`_.
...
Related Information
-------------------
For more information, see the `Glossary <https://docs.sqream.com/en/v2021.1.1/glossary.html>`_.