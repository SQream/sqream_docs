...
2. Download the most current version of the `SQream JDBC driver <https://docs.sqream.com/en/v2020-1/third_party_tools/client_drivers/index.html>`_.
...
8. In the Data Source panel, do the following:
   ...
   6. In the **Connection String** text box, type the relevant connection string and path to the JDBC jar file using the following syntax:
      ...
      For more information about the available **connection parameters** and other examples, see `Connection Parameters <https://docs.sqream.com/en/v2020-1/third_party_tools/client_drivers/jdbc/index.html#connection-parameters>`_.
