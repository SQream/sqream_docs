...
************************************
Client Drivers for Version 2021.2.1.24
************************************
...
* **JDBC** - recommended installation via ``mvn``:
  ...
  * `JDBC driver <https://docs.sqream.com/en/v2021.2.1.24/third_party_tools/client_drivers/jdbc/index.html#>`_
...
* **Python** - Recommended installation via ``pip``:
  ...
  * `Python driver <https://docs.sqream.com/en/v2021.2.1.24/third_party_tools/client_drivers/python/index.html>`_
...
* **Node.JS** - Recommended installation via ``npm``:
  ...
  * `Node.JS driver <https://docs.sqream.com/en/v2021.2.1.24/third_party_tools/client_drivers/nodejs/index.html>`_
...
* **Tableau**:
  ...
  * `Tableau manual installation <https://docs.sqream.com/en/v2021.2.1.24/third_party_tools/client_platforms/tableau.html#>`_
...
* **Power BI**:
  ...
  * `Power BI manual installation <https://docs.sqream.com/en/v2021.2.1.24/third_party_tools/client_platforms/power_bi.html>`_
...
* `Sqream SQL CLI Reference <https://docs.sqream.com/en/v2021.2.1.24/reference/cli/sqream_sql.html#sqream-sql-cli-reference>`_ - Interactive command-line SQL client for Intel-based machines
...
* `Sqream SQL CLI Reference <https://docs.sqream.com/en/v2021.2.1.24/reference/cli/sqream_sql.html#sqream-sql-cli-reference>`_ - Interactive command-line SQL client for IBM POWER9-based machines
...
* `C++ shared object library <https://docs.sqream.com/en/v2021.2.1.24/third_party_tools/client_drivers/cpp/index.html#getting-the-library>`_
