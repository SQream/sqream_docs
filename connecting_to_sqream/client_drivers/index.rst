...
.. list-table::
   ...
   * - Driver
     ...
     - Operating System
   * - **SQream DB Java CLI**
     - `SQream DB Java Command Line Interface <https://sq-ftp-public.s3.us-east-1.amazonaws.com/jdbc-console-release/jdbc-console-2.11-v1.zip>`_ 
   ...
   * - **Dataiku**
     ...
     - All
   * - **JDBC**
     - `sqream-jdbc <https://sq-ftp-public.s3.us-east-1.amazonaws.com/sqream-jdbc-release/sqream-jdbc-6.6.jar>`_
     - :ref:`java_jdbc`
