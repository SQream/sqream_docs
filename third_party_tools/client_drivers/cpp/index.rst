...
The C++ driver is provided as a tarball containing the compiled ``libsqream.so`` file and a header ``sqream.h``. Get the driver from the `SQream Drivers page <https://docs.sqream.com/en/v2020.3/third_party_tools/client_drivers/index.html>`_. The library can be integrated into your C++-based applications or projects.
