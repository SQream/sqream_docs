...
* **JDBC** - recommended installation via ``mvn``:
  ...
  * `JDBC driver <https://docs.sqream.com/en/v2020-2/guides/client_drivers/jdbc/index.html#java-jdbc>`_
...
* **Python** - Recommended installation via ``pip``:
  ...
  * `Python driver <https://docs.sqream.com/en/v2020-2/guides/client_drivers/python/index.html#pysqream>`_
...
* **Node.JS** - Recommended installation via ``npm``:
  ...
  * `Node.JS driver <https://docs.sqream.com/en/v2020-2/guides/client_drivers/nodejs/index.html#nodejs>`_
...
* **Tableau**:
  ...
  * `Tableau manual installation <https://docs.sqream.com/en/v2020-2/guides/third_party_tools/tableau.html#tableau-manual-installation>`_
...
* `C++ shared object library <https://docs.sqream.com/en/v2020-2/guides/client_drivers/cpp/index.html#getting-the-library>`_
