...
* `Sqream SQL CLI Reference <https://docs.sqream.com/en/v2020-1/reference/cli/sqream_sql.html#sqream-sql-cli-reference>`_ - Interactive command-line SQL client for Intel-based machines
...
* `Sqream SQL CLI Reference <https://docs.sqream.com/en/v2020-1/reference/cli/sqream_sql.html#sqream-sql-cli-reference>`_ - Interactive command-line SQL client for IBM POWER9-based machines
...
If you're looking for an older version of SQream DB drivers, versions 1.10 through 2019.2.1 are available at `Client Drivers for 2020.1 <https://docs.sqream.com/en/v2020-1/third_party_tools/client_drivers/index.html>`_.