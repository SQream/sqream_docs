...
#. Get the JDBC driver installer available for download from the `SQream Drivers page <https://docs.sqream.com/en/v2020.3/third_party_tools/client_drivers/index.html>`_. The Windows installer takes care of the Java prerequisites and subsequent configuration.
...
SQream DB's JDBC driver is provided as a zipped JAR file, available for download from the `SQream Drivers page <https://docs.sqream.com/en/v2020.3/third_party_tools/client_drivers/index.html>`_. 
