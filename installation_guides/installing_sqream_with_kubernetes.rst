...
If the above output is not generated, CUDA has not been installed. To install CUDA, see `Installing the CUDA driver <https://docs.sqream.com/en/latest/installation_guides/recommended_pre-installation_configurations.html#installing-the-nvidia-cuda-driver>`_.
