...
For more information, see the `upgrade_storage <https://docs.sqream.com/en/v2021.1/reference/cli/upgrade_storage.html>`_ command line program.

For more information about installing Studio on a stand-alone server, see `Installing Studio on a Stand-Alone Server <https://docs.sqream.com/en/v2021.1/installation_guides/installing_studio_on_stand_alone_server.html>`_.