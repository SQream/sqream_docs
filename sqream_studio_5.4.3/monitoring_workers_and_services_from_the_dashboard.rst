...
--------------------------
Services are used to categorize and associate (also known as **subscribing**) workers to particular services. The **Service** panel is used for viewing, monitoring, and adding defined `service queues <https://docs.sqream.com/en/v2020.3.2/feature_guides/workload_manager.html>`_.
...
* `Workers <https://docs.sqream.com/en/v2020.3.2/reference/cli/sqream_console.html#workers>`_
...
For more information on the current query plan, see `SHOW_NODE_INFO <https://docs.sqream.com/en/v2020.3.2/reference/sql/sql_statements/monitoring_commands/show_node_info.html#show-node-info>`_. For more information on checking active sessions across the cluster, see `SHOW_SERVER_STATUS <https://docs.sqream.com/en/v2020.3.2/reference/sql/sql_statements/monitoring_commands/show_server_status.html>`_.
