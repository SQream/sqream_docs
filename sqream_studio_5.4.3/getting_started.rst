...
----------------
Studio is included with all `dockerized installations of SQream DB <https://docs.sqream.com/en/v2021.2/installation_guides/running_sqream_in_a_docker_container.html>`_. When starting Studio, it listens on the local machine on port 8080.
