...
----------------
Studio is included with all :ref:`dockerized installations of SQream DB<running_sqream_in_a_docker_container>`. When starting Studio, it listens on the local machine on port 8080.
