...
* `Enabling the Query Healer <https://docs.sqream.com/en/latest/configuration_guides/is_healer_on.html>`_
* `Configuring the Query Healer <https://docs.sqream.com/en/latest/configuration_guides/healer_max_inactivity_hours.html>`_