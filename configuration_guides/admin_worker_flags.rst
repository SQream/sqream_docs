...
* `Enabling the Query Healer <https://docs.sqream.com/en/v2020.3.2.1/configuration_guides/is_healer_on.html>`_
* `Configuring the Query Healer <https://docs.sqream.com/en/v2020.3.2.1/configuration_guides/healer_max_inactivity_hours.html>`_
* `Adjusting Permitted Log-in Attempts <https://docs.sqream.com/en/v2020.3.2.1/configuration_guides/login_max_retries.html>`_