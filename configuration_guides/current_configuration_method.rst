...
* `Administration flags <https://docs.sqream.com/en/v2021.2/configuration_guides/admin_flags.html>`_: can be modified by administrators on a session and cluster basis using the ``ALTER SYSTEM SET`` command.
* `Generic flags <https://docs.sqream.com/en/v2021.2/configuration_guides/generic_flags.html>`_: can be modified by standard users on a session basis.
