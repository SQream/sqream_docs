...
* `Using SQream SQL <https://docs.sqream.com/en/v2020.3.1/reference/cli/sqream_sql.html#using-sqream-sql>`_ - modifying flag attributes from the CLI.
* `SQream Acceleration Studio <https://docs.sqream.com/en/v2020.3.1/guides/operations/sqream_studio_5.4.0.html>`_ - modifying flag attributes from Studio.
...
* `Administration flags <https://docs.sqream.com/en/v2020.3.1/configuration_guides/admin_flags.html>`_: can be modified by administrators on a session and cluster basis using the ``ALTER SYSTEM SET`` command.
* `Generic flags <https://docs.sqream.com/en/v2020.3.1/configuration_guides/generic_flags.html>`_: can be modified by standard users on a session basis.
