...
.. note:: 
   ...
   * SQream DB identifier names such as table names and column names are not case sensitive. SQream DB lowercase all identifiers by default. If you want to maintain case, enclose the identifiers with double-quotes.
